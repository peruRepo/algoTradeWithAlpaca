...
@Profile("paper")
@Component
public class AlpacaPaperTradingServiceProvider implements TradingServiceProvider<AlpacaAPI, AlpacaWebsocketClient>{
	...
	public AlpacaAPI getTradingAPI() throws TradingServiceProviderException {
		...
		keyId = System.getenv("alpaca_paper_api_keyId");
		secret = System.getenv("alpaca_paper_api_secret");
